/*
	...
	Change History (most recent first):
	   ...
	   <SM5>	12-04-92	jmp		Fixed a 32-bit cleanliness problem and temporarily changed
									'decl' back to 'CODE' as I checked 3.2Õs Linker into the
									project.
	  ...
	  else
	    {
		   ...
		   if (CodeHandle == nil)
		   ...
		   else
		     {
			   ...
			   HLock(CodeHandle);			// Make sure it doesnÕt move.
			   ...
			   // 'CODE' resourceÕs jump table.  With the 3.2 Linker, this is no longer done
